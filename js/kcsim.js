...
var VANGUARD1 = {shellmod:0.5,torpmod:1,ASWmod:1,AAmod:1.1, shellacc:0.8,torpacc:0.7,aswacc:1,NBacc:0.8, shellev:1,torpev:1,NBev:1,ASWev:1, id:6};
var VANGUARD2 = {shellmod:1,torpmod:1,ASWmod:.6,AAmod:1.1, shellacc:1.2,torpacc:0.9,aswacc:1.1,NBacc:1.2, shellev:1,torpev:1,NBev:1,ASWev:1, id:6};
...
var CTFCOMBINED2M = {shellmod:1,torpmod:.9,ASWmod:1.1,AAmod:1, shellbonus:2,shellbonusE:10,accbase:78, shellacc:1,torpacc:1,NBacc:1, shellev:1.3,torpev:1,NBev:1,ASWev:1, id:12};
var CTFCOMBINED2E = {shellmod:1,torpmod:.9,ASWmod:1.1,AAmod:1, shellbonus:10,shellbonusE:5,accbase:45, shellacc:1,torpacc:1,NBacc:1, shellev:1.3,torpev:1,NBev:1,ASWev:1, id:12};
var CTFCOMBINED3M = {shellmod:.7,torpmod:.6,ASWmod:1,AAmod:1.5, shellbonus:2,shellbonusE:10,accbase:78, shellacc:.8,torpacc:.6,NBacc:1, shellev:1.1,torpev:1,NBev:1,ASWev:1, id:13};
var CTFCOMBINED3E = {shellmod:.7,torpmod:.6,ASWmod:1,AAmod:1.5, shellbonus:10,shellbonusE:5,accbase:45, shellacc:.8,torpacc:.6,NBacc:1, shellev:1.1,torpev:1,NBev:1,ASWev:1, id:13};
var CTFCOMBINED4M = {shellmod:1.1,torpmod:1,ASWmod:.7,AAmod:1, shellbonus:2,shellbonusE:10,accbase:78, shellacc:1.1,torpacc:1.2,NBacc:1, shellev:1,torpev:1,NBev:1,ASWev:1, id:14};
var CTFCOMBINED4E = {shellmod:1.1,torpmod:1,ASWmod:.7,AAmod:1, shellbonus:10,shellbonusE:5,accbase:45, shellacc:1.1,torpacc:1.2,NBacc:1, shellev:1,torpev:1,NBev:1,ASWev:1, id:14};
...
var STFCOMBINED2M = {shellmod:1,torpmod:.9,ASWmod:1.1,AAmod:1, shellbonus:10,shellbonusE:5,accbase:45, shellacc:1,torpacc:1,NBacc:1, shellev:1.3,torpev:1,NBev:1,ASWev:1, id:12};
var STFCOMBINED2E = {shellmod:1,torpmod:.9,ASWmod:1.1,AAmod:1, shellbonus:-5,shellbonusE:-5,accbase:67, shellacc:1,torpacc:1,NBacc:1, shellev:1.3,torpev:1,NBev:1,ASWev:1, id:12};
var STFCOMBINED3M = {shellmod:.7,torpmod:.6,ASWmod:1,AAmod:1.5, shellbonus:10,shellbonusE:5,accbase:45, shellacc:.8,torpacc:.6,NBacc:1, shellev:1.1,torpev:1,NBev:1,ASWev:1, id:13};
var STFCOMBINED3E = {shellmod:.7,torpmod:.6,ASWmod:1,AAmod:1.5, shellbonus:-5,shellbonusE:-5,accbase:67, shellacc:.8,torpacc:.6,NBacc:1, shellev:1.1,torpev:1,NBev:1,ASWev:1, id:13};
var STFCOMBINED4M = {shellmod:1.1,torpmod:1,ASWmod:.7,AAmod:1, shellbonus:10,shellbonusE:5,accbase:45, shellacc:1.1,torpacc:1.2,NBacc:1, shellev:1,torpev:1,NBev:1,ASWev:1, id:14};
var STFCOMBINED4E = {shellmod:1.1,torpmod:1,ASWmod:.7,AAmod:1, shellbonus:-5,shellbonusE:-5,accbase:67, shellacc:1.1,torpacc:1.2,NBacc:1, shellev:1,torpev:1,NBev:1,ASWev:1, id:14};
...
var TTFCOMBINED2M = {shellmod:1,torpmod:.9,ASWmod:1.1,AAmod:1, shellbonus:-5,shellbonusE:10,accbase:54, shellacc:1,torpacc:1,NBacc:1, shellev:1.3,torpev:1,NBev:1,ASWev:1, id:12};
var TTFCOMBINED2E = {shellmod:1,torpmod:.9,ASWmod:1.1,AAmod:1, shellbonus:10,shellbonusE:5,accbase:45, shellacc:1,torpacc:1,NBacc:1, shellev:1.3,torpev:1,NBev:1,ASWev:1, id:12};
var TTFCOMBINED3M = {shellmod:.7,torpmod:.6,ASWmod:1,AAmod:1.5, shellbonus:-5,shellbonusE:10,accbase:54, shellacc:.8,torpacc:.6,NBacc:1, shellev:1.1,torpev:1,NBev:1,ASWev:1, id:13};
var TTFCOMBINED3E = {shellmod:.7,torpmod:.6,ASWmod:1,AAmod:1.5, shellbonus:10,shellbonusE:5,accbase:45, shellacc:.8,torpacc:.6,NBacc:1, shellev:1.1,torpev:1,NBev:1,ASWev:1, id:13};
var TTFCOMBINED4M = {shellmod:1.1,torpmod:1,ASWmod:.7,AAmod:1, shellbonus:-5,shellbonusE:10,accbase:54, shellacc:1.1,torpacc:1.2,NBacc:1, shellev:1,torpev:1,NBev:1,ASWev:1, id:14};
var TTFCOMBINED4E = {shellmod:1.1,torpmod:1,ASWmod:.7,AAmod:1, shellbonus:10,shellbonusE:5,accbase:45, shellacc:1.1,torpacc:1.2,NBacc:1, shellev:1,torpev:1,NBev:1,ASWev:1, id:14};
...
var NBATTACKDATA = {
	...
	9: { dmgMod: 1.5, accMod: 1.65, chanceMod: 1.25, improve: 13, improveChance: .89, torpedo: true, name: 'DDCI (LTT)' },  // data: yumemi
...
var SIMCONSTS = {
	...
	kongouSpecialRate: 65,
	yamato3SpecialRate: 80,
	yamato2SpecialRate: 80,
	airRaidCostW6: false,
...
function NBattack(ship,target,NBonly,NBequips,APIyasen,attackSpecial) {
	...
	var critrateMod = 1.5;
	if (nightscouts[0]) {
		if (nightscouts[0].ACC >= 3) {bonus = 9; accBaseMod = 1.2; critrateMod = 1.7}
		else if (nightscouts[0].ACC == 2) {bonus = 7; accBaseMod = 1.15; critrateMod = 1.64}
		else {bonus = 5; accBaseMod = 1.1; critrateMod = 1.57}
	}
	
	var accBase = (69 + starshells[0]*5)*accBaseMod;
...
function canSpecialAttack(ship) {
	if (!ship.attackSpecial) return 0;
	if (ship.fleet.didSpecial) return 0;
	if (ship.attackSpecial.indexOf(100) !== -1) {
		let flag = true;
		if (ship.fleet.ships[0] != ship || ship.isescort) flag = false;
		else if (ship.fleet.ships.filter(ship => ship.HP > 0 && !ship.retreated && !ship.isSub).length < 6) flag = false;
		else if (ship.fleet.formation.id != 12 && ship.fleet.formation.id != 2) flag = false;
		else if (ship.HP/ship.maxHP <= .5) flag = false;
		else if (ship.fleet.ships[2].CVshelltype || ship.fleet.ships[4].CVshelltype) flag = false;
		if (flag && Math.random() < SIMCONSTS.nelsonTouchRate/100) return 100;
	}
	if (ship.attackSpecial.indexOf(101) !== -1) {
		let flag = true;
		if (ship.fleet.ships[0] != ship || ship.isescort) flag = false;
		else if (ship.fleet.ships.filter(ship => ship.HP > 0 && !ship.retreated && !ship.isSub).length < 6) flag = false;
		else if (ship.fleet.formation.id != 12 && ship.fleet.formation.id != 4) flag = false;
		else if (ship.HP/ship.maxHP <= .5) flag = false;
		else if (['BB','FBB','BBV'].indexOf(ship.fleet.ships[1].type) == -1) flag = false;
		else if (ship.fleet.ships[1].HP/ship.fleet.ships[1].maxHP <= .25) flag = false;
		if (flag && Math.random() < SIMCONSTS.nagatoSpecialRate/100) return 101;
	}
	if (ship.attackSpecial.indexOf(102) !== -1) {
		let flag = true;
		if (ship.fleet.ships[0] != ship || ship.isescort) flag = false;
		else if (ship.fleet.ships.filter(ship => ship.HP > 0 && !ship.retreated && !ship.isSub).length < 6) flag = false;
		else if (ship.fleet.formation.id != 12 && ship.fleet.formation.id != 4) flag = false;
		...
		if (flag && Math.random() < SIMCONSTS.mutsuSpecialRate/100) return 102;
	} 
	if (ship.attackSpecial.indexOf(103) !== -1) {
		let flag = true;
		if (ship.fleet.ships[0] != ship || ship.isescort) flag = false;
		else if (ship.fleet.ships.filter(ship => ship.HP > 0 && !ship.retreated && !ship.isSub).length < 6) flag = false;
		else if (ship.fleet.formation.id != 12 && ship.fleet.formation.id != 4) flag = false;
		else if (ship.HP/ship.maxHP <= .5) flag = false;
		else if (['BB','FBB','BBV'].indexOf(ship.fleet.ships[1].type) == -1 || ship.fleet.ships[1].HP / ship.fleet.ships[1].maxHP <= .25) flag = false;
		else if (['BB','FBB','BBV'].indexOf(ship.fleet.ships[2].type) == -1 || ship.fleet.ships[2].HP / ship.fleet.ships[2].maxHP <= .25) flag = false;
		if (flag && Math.random() < SIMCONSTS.coloradoSpecialRate/100) return 103;
	}
	if (ship.attackSpecial.indexOf(400) !== -1) {
		let flag = true
		if (ship.fleet.ships[0] != ship || ship.isescort) flag = false;
		else if (ship.fleet.ships.filter(ship => ship.HP > 0 && !ship.retreated && !ship.isSub).length < 6) flag = false;
		else if (ship.fleet.formation.id != 14 && ship.fleet.formation.id != 4) flag = false;
		else if (ship.HP/ship.maxHP <= .5) flag = false;
		else if (['BB','FBB','BBV'].indexOf(ship.fleet.ships[1].type) == -1 || ship.fleet.ships[1].HP / ship.fleet.ships[1].maxHP <= .5) flag = false;
		else if (['BB','FBB','BBV'].indexOf(ship.fleet.ships[2].type) == -1 || ship.fleet.ships[2].HP / ship.fleet.ships[2].maxHP <= .5) flag = false;
		else {
			...
			else if (ship.fleet.ships[2].mid == 546) flag = false;
		}
		if (flag && Math.random() < SIMCONSTS.yamato3SpecialRate/100) return 400;
	} 
	if (ship.attackSpecial.indexOf(401) !== -1) {
		let flag = true;
		if (ship.fleet.ships[0] != ship || ship.isescort) flag = false;
		else if (ship.fleet.ships.filter(ship => ship.HP > 0 && !ship.retreated && !ship.isSub).length < 6) flag = false;
		else if (ship.fleet.formation.id != 14 && ship.fleet.formation.id != 4) flag = false;
		...
		else if (ship.mid == 546) {
			if ([911,916].indexOf(ship.fleet.ships[1].mid) === -1) flag = false;
		} else {
			if ([546,178,360,392].indexOf(ship.fleet.ships[1].mid) === -1) flag = false;
		}
		if (flag && Math.random() < SIMCONSTS.yamato2SpecialRate/100) return 401;
	}
	return 0;
}
...
function canSpecialAttackNB(ship) {
	if (!ship.attackSpecial) return 0;
	if (ship.fleet.didSpecialNB[0] && ship.fleet.didSpecialNB[1]) return 0;
	if (ship.attackSpecial.indexOf(104) !== -1) {
		if (ship.fleet.ships[0] != ship) return 0;
		if (ship.fleet.ships.filter(ship => ship.HP > 0 && !ship.retreated && !ship.isSub).length < 5) return 0;
		if (ship.fleet.formation.id != 1 && ship.fleet.formation.id != 4 && ship.fleet.formation.id != 12 && ship.fleet.formation.id != 14) return 0;
		for (let i=0; i<=1; i++) {
			let s = ship.fleet.ships[i];
			if (s.HP/s.maxHP <= .5) return 0;
		}
		if (ship.mid == 591 && [592,151,439,364].indexOf(ship.fleet.ships[1].mid) == -1) return 0;
		if (ship.mid == 592 && [591,152].indexOf(ship.fleet.ships[1].mid) == -1) return 0;
...
function getSpecialAttackShips(ships,attackSpecial) {
	let attackers;
	if (attackSpecial == 101 || attackSpecial == 102 || attackSpecial == 401) {
		attackers = [ships[0], ships[0], ships[1]];
	} else if (attackSpecial == 100) {
		attackers = [ships[0], ships[2], ships[4]];
	} else if (attackSpecial == 103 || attackSpecial == 400) {
...
function getSpecialAttackMod(ship,attackSpecial) {
	...
	if (attackSpecial == 100) {
		...
		mod = 1.5;
		if (ship.isflagship && [546,541,573,553,554].indexOf(ship.fleet.ships[1].mid)) mod *= 1.1;
		if (ship.num == 2) {
			if (ship.mid == 546) mod *= 1.2;
			else if ([541,573].indexOf(ship.mid) !== -1) mod *= 1.1;
			else if ([553,554].indexOf(ship.mid) !== -1) mod *= 1.05;
		}
		if (ship.num == 3) mod *= 1.1;
		if (ship.equiptypesB[B_APSHELL]) mod *= 1.35;
		if (ship.hasLOSRadar) mod *= 1.15;
...
function getSpecialAttackCost(attackSpecial){
	switch(attackSpecial){
		case 101:
		case 102:
		case 103:
		...
		if (i < order1.length && order1[i].canStillShell()) {
			...
			if (attackSpecialId && !isOASW) {
				...
				for (; k<ships.length; k++) {
					...
					shellPhaseAttack(ships[k],targetData,APIhou,isOASW,attackSpecialId);
					ships[k].didSpecial = attackSpecialId;
				}
		...
		if (i < order1.length && order1[i].canStillShell()) {
			...
			if (attackSpecialId && !isOASW) {
				...
				for (; k<ships.length; k++) {
					...
					doShellC(ships[k],targets,APIhou,isOASW,attackSpecialId);
					ships[k].didSpecial = attackSpecialId;
				}
				order1[i].fleet.didSpecial = 1;
				if (C) {
		...
		if (i < order1.length && order1[i].canNB()) {
			...
			if (attackSpecialId) {
				...
				for (; k<ships.length; k++) {
					...
					if (NBattack(ships[k],target,NBonly,[[star1,star2],[light1,light2],[scout1,scout2]],APIhou,attackSpecialId)) alive2.splice(alive2.indexOf(target),1);
					ships[k].didSpecial = attackSpecialId;
				}
				if (attackSpecialId == 104) {
					if (order1[i].fleet.didSpecialNB[0]) order1[i].fleet.didSpecialNB[1] = 1;
					else order1[i].fleet.didSpecialNB[0] = 1;
				} else order1[i].fleet.didSpecial = 1;
				if (C) {
					apiAdjustHougekiSpecial(APIhou,k);
				}
...
function getNightContact(ships) {
	var contacter = null;
	ships.forEach((ship) => {
		if (!ship.hasNightScout) return;
		ship.equips.forEach((equip) => {
			if (!equip.isnightscout) return;
			if (contacter && ((contacter.ACC||0) >= (equip.ACC||0))) return;
			if (Math.random() < Math.floor(Math.sqrt(ship.LVL||1)*Math.sqrt(equip.LOS||0))/25) contacter = equip;
		})
	})
	return contacter;
}
...
function updateSupply(ships,targets,didNB,NBonly,bombing,noammo,isECombined) {
	...
	for (var i=0; i<ships.length; i++) {
		...
		if (costAmmo > 0) {
			...
			if (ships[i].didSpecial) {
				if (!isECombined || !didNB) subAmmo = Math.floor(subAmmo*getSpecialAttackCost(ships[i].didSpecial));
				delete ships[i].didSpecial;
			}
